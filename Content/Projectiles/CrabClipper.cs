...
namespace FishDebt.Content.Projectiles
{
    public class CrabClipper : ModProjectile
    {
...
namespace FishDebt.Content.Projectiles
{
	...
	public class CrabClipper : ModProjectile
	{
		...
		public override void SetDefaults()
		{
			...
			Projectile.alpha = 1; // How transparent to draw this projectile. 0 to 255. 255 is completely transparent.
		}
